...
namespace MathNet.Numerics.Optimization
{
    ...
    public class NullEvaluation : BaseEvaluation
    {
        ...
        {
            _point = new DenseVector(new double[] { point });
            _status = EvaluationStatus.None;
        }
    ...
    public class OneDEvaluationExpander : IEvaluation
    {
        ...
        {
            get { return new DenseVector(new double[] { this.InnerEval.Point }); }
        }
        ...
        public Vector<double> Gradient
        {
            get { return new DenseVector(new double[] { this.InnerEval.Derivative }); }
        }

        public Matrix<double> Hessian
        {
            get { return new DenseMatrix(1, 1, new double[] { this.InnerEval.SecondDerivative }); }
        }
    }
